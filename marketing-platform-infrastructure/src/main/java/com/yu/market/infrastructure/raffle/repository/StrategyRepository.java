...
import com.yu.market.infrastructure.raffle.mapper.*;
import com.yu.market.infrastructure.raffle.pojo.*;
...
public class StrategyRepository implements IStrategyRepository {
	...
	public int getRateRange(String cacheKey) {
		...
		if (!redisService.isExists(cacheKey)) {
			throw new ServiceException(BaseErrorCode.UN_ASSEMBLED_STRATEGY_ARMORY);
		}
