...
import com.yu.market.common.idempotent.enums.IdempotentMQConsumeStatusEnum;
import com.yu.market.common.idempotent.utils.SpELUtil;
...
public final class NoMQDuplicateConsumeAspect {
     ...
     */
    @Around("@annotation(com.yu.market.common.idempotent.anno.NoMQDuplicateConsume)")
